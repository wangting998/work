package com.bh.java.kind.characher;
...
public class CharacterDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println("isUpperCase:" + Character.isLowerCase('a')); //true
        System.out.println("isUpperCase:" + Character.isLowerCase('0')); //false
        System.out.println("--------------");
